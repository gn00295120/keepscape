# Keepscape deterministic sample archive
...
> Three lanterns hung over the lane: one painted, one tasseled, one pale as moonlight. I kept the red paper
> ticket tucked behind the photograph. A bicycle bell rang as we reached the last lantern.

Duration: approximately 11.62 seconds. Cited sentence ranges are 0.00–5.28, 5.53–8.62, and 8.87–11.61.

## Repair-bench transcript

> First turn the bicycle over and let the seat and handlebars hold it steady. Next use the small wrench to
> loosen the wheel. Set the chain back on its teeth, spin the wheel, and ring the bell when it runs clean.

Duration: approximately 11.37 seconds. Cited sentence ranges are 0.00–3.96, 4.21–6.53, and 6.78–11.36.
